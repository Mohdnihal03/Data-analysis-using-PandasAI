...
st.set_page_config(page_title="Data Analysis using PandasAI", page_icon="📄", layout="wide")

# Add header with title and description
st.markdown(
    '<p style="display:inline-block;font-size:40px;font-weight:bold;">📊Data Analysis using PandasAI </p>'
    ' <p style="display:inline-block;font-size:16px;">tool uses AI-powered , '
